...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.createAPIKeyRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.Project"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.addMemberRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.Report"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.exportRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/runs": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.TestRun"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Start Run Details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.startRunRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.AggregatedMetric"
                            }
                        }
                    },
                    "401": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.Scenario"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.generateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_api_handler.cloneRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_mr-isik_gatling-backend_internal_domain.AggregatedMetric": {
            "type": "object",
            "properties": {
                "active_vus": {
                    "type": "integer"
        ...
        "github_com_mr-isik_gatling-backend_internal_domain.Anomaly": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
                ...
                "type": {
                    "description": "latency_spike, error_surge, throughput_drop",
                    "type": "string"
                }
            }
        },
        "github_com_mr-isik_gatling-backend_internal_domain.Check": {
            "type": "object",
            "properties": {
                "operator": {
                    "description": "eq, gt, contains",
                    "type": "string"
                },
                "type": {
                    "description": "status, body_contains, json_path",
                    "type": "string"
                },
                "value": {
                    "type": "string"
        ...
        "github_com_mr-isik_gatling-backend_internal_domain.Project": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "github_com_mr-isik_gatling-backend_internal_domain.Report": {
            "type": "object",
            "properties": {
                "ai_recommendations": {
                    "type": "array",
                ...
                "anomalies": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.Anomaly"
                    }
                },
                "created_at": {
                    "type": "string"
                ...
                "summary": {
                    "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.Summary"
                }
            }
        },
        "github_com_mr-isik_gatling-backend_internal_domain.RunConfig": {
            "type": "object",
            "properties": {
                "baseline_run_id": {
                    "type": "string"
        ...
        "github_com_mr-isik_gatling-backend_internal_domain.RunStatus": {
            "type": "string",
            "enum": [
                "pending",
                "running",
        ...
        "github_com_mr-isik_gatling-backend_internal_domain.Scenario": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
                ...
                "steps": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.Step"
                    }
                },
                "tags": {
                    "type": "array",
        ...
        "github_com_mr-isik_gatling-backend_internal_domain.Step": {
            "type": "object",
            "properties": {
                "body": {
                    "type": "string"
                ...
                "checks": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.Check"
                    }
                },
                "headers": {
                    "type": "object",
        ...
        "github_com_mr-isik_gatling-backend_internal_domain.Summary": {
            "type": "object",
            "properties": {
                "avg_latency": {
                    "type": "number"
        ...
        "github_com_mr-isik_gatling-backend_internal_domain.TestRun": {
            "type": "object",
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.RunConfig"
                },
                "created_at": {
                    "type": "string"
                },
        ...
        "internal_api_handler.addMemberRequest": {
            "type": "object",
            "properties": {
                "role": {
                    "type": "string"
        ...
        "internal_api_handler.cloneRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "internal_api_handler.createAPIKeyRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "internal_api_handler.exportRequest": {
            "type": "object",
            "properties": {
                "format": {
                    "type": "string"
        ...
        "internal_api_handler.generateRequest": {
            "type": "object",
            "properties": {
                "prompt": {
                    "type": "string"
        ...
        "internal_api_handler.startRunRequest": {
            "type": "object",
            "properties": {
                "config": {
                    "$ref": "#/definitions/github_com_mr-isik_gatling-backend_internal_domain.RunConfig"
